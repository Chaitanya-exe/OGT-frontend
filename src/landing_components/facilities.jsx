...
export default function Facilities(){
  return (
    <motion.div variants={variants} initial="initial" whileInView="animate" className='flex flex-col md:grid md:grid-cols-3 md:gap-y-10  md:items-baseline md:gap-x-1 space-y-6 my-20'>
      <motion.div variants={variants} className='text-slate-900 h-full shadow hover:-translate-y-3 hover:scale-105 transition-all duration-300  bg-slate-100 p-6 rounded-xl mx-10 '>
