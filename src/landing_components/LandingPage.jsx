  ...
  return (
    <>
      <motion.div
        ...
        className={`${isDeveloperChecked ? "bg-gradient-to-l  from-pink-300 via-orange-200 to-blue-200" : "bg-gradient-to-l from-purple-200 via-blue-200 to-pink-100" }  delay-150 font-fontBody transition-all duration-1000 ease-in-out`}
      >
