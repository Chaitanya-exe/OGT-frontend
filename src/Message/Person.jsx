...
const Person = () => {
  ...
  return (
    <div onClick={() => {setOpenChat(true)}} className='hover:bg-slate-200 py-1 px-2 rounded-md flex justify-start items-center space-x-3'>
...
<p className='text-sm truncate max-w-56 text-wrap'>text </p>
      </div>
